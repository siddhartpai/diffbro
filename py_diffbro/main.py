...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="gpt-4o",
        help="GPT model use 'gpt-3.5-turbo' or 'gpt-4' or 'gpt-4o'",
    )
    parser.add_argument(
        "--only",
        nargs="*",
    ...
    if args.mid:
        ...
        if model != "gpt-4o":
            user_input = input(
                "Chad mode is engaged. It is suggested to use 'gpt-4o' model for optimal results. Do you want to switch to 'gpt-4o'? (y/n): "
            )
